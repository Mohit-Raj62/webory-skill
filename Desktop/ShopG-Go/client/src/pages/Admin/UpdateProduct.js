...
const UpdateProduct = () => {
    ...
    const handleUpdate = async (e) => {
        ...
        try {
            ...
            if (data?.success) {
                ...
                toast.error('Product created not found');
            }
        }
        catch (error) {
            console.log(error);
    ...
    const handleDelete = async () => {
        try {
            ...
            console.log(error)
            toast.error('Product delete not found');
        }
    };
    return (
        <Layout title={"Dashboard Update-Product Mi Zip"}>
                        ...
                        <div className='m-1 w-75'>
                            ...
                            <div className='mb-3' >
                                <Select
                                    ...
                                    onChange={(value = { shipping }) => { setShipping(value) }}
                            ...
                            <div className='mb-3'>
                                <button className='btn btn-primary' onClick={handleUpdate} id="form">
                                    UPDATE PRODUCT
                                </button>
                            </div>
                            <div className='mb-3'>
                                <button className='btn btn-danger' onClick={handleDelete} id="form">
                                    UPDATE PRODUCT
                                </button>
                            </div>
                        </div>
