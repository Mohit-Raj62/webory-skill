                            ...
                            <div className="flex justify-between items-start">
                                ...
                                <div className="flex gap-2">
                                    <Button
                                        variant="outline"
                                        size="sm"
                                        onClick={() => router.push(`/admin/courses/${courseId}/assignments/${assignment._id}/submissions`)}
                                    >
                                        View Submissions
                                    </Button>
                                    <Button
                                        variant="outline"
                                        size="sm"
                                        onClick={() => router.push(`/admin/courses/${courseId}/assignments/${assignment._id}/edit`)}
                                    >
                                        <Edit size={16} />
                                    </Button>
                                    <Button
