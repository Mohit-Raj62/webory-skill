...
import { ArrowLeft, Plus, X, Upload, Image, Trash2, Video, DollarSign, Tag, Layers, CheckCircle, Loader2, Save } from "lucide-react";
    ...
    const handleSubmit = async (e?: React.FormEvent) => {
        ...
        try {
            ...
            if (res.ok) {
                ...
                toast.error(data.error || "Failed to create internship");
            }
        } catch (error) {
            ...
            <div className="sticky top-0 z-50 flex items-center justify-between mb-8 bg-black/60 backdrop-blur-xl p-4 rounded-2xl border border-white/10 shadow-2xl">
                <div>
                    ...
                    <h1 className="text-3xl font-bold text-white bg-clip-text text-transparent bg-gradient-to-r from-white to-gray-400">
                        {formData.title || "Add New Internship"}
                    </h1>
                </div>
                <div className="flex items-center gap-4">
                    ...
                    >
                        ...
                        {saving ? "Saving..." : "Create Internship"}
                    </Button>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 xl:grid-cols-3 gap-8">
                                                ...
                                                <div className="space-y-2">
                                                    {module.videos.map((video, vIdx) => (
                                                        <div key={vIdx} className="flex items-center justify-between p-3 bg-black/40 rounded-xl border border-white/5">
                                                            ...
                                                            }} className="text-red-400 hover:text-red-300 hover:bg-red-500/10"><X size={16} /></Button>
                                                        </div>
                                                    ))}
                                                </div>
                ...
                <div className="xl:col-span-1 space-y-8">
                    ...
                    <div className="mt-8 text-center text-sm text-gray-400 italic">
                        Note: You can add PDF resources to this internship after it has been created.
                    </div>
