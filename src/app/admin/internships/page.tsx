...
import { Plus, Edit, Trash2, Search, FileText, Eye, EyeOff, Users, ClipboardList } from "lucide-react";
                                ...
                                <tr key={internship._id} className="border-b border-white/5 hover:bg-white/5 transition-colors">
                                    ...
                                    <td className="px-6 py-4">
                                        <div className="flex gap-2">
                                            ...
                                            <Link href={`/admin/live?type=internship&internshipId=${internship._id}`}>
                                                <button className="p-2 hover:bg-emerald-500/10 rounded-lg transition-colors text-emerald-400" title="Go Live">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M23 7l-7 5 7 5V7z"></path><rect x="1" y="5" width="15" height="14" rx="2" ry="2"></rect></svg>
                                                </button>
                                            </Link>
                                            <button
                                                onClick={() => {
