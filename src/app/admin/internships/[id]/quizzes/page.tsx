        ...
        <div className="p-8">
            <div className="mb-8">
                ...
                <div className="flex justify-between items-center">
                    ...
                    <Link href={`/admin/internships/${internshipId}/quizzes/new`}>
                            ...
                            <div className="flex justify-between items-start">
                                ...
                                <div className="flex gap-2">
                                    <Button
                                        variant="outline"
                                        size="sm"
                                        onClick={() => router.push(`/admin/internships/${internshipId}/quizzes/${quiz._id}/results`)}
                                    >
                                    ...
                                    <Button
                                        variant="outline"
                                        size="sm"
                                        onClick={() => router.push(`/admin/internships/${internshipId}/quizzes/${quiz._id}/edit`)}
                                    >
                                        <Edit size={16} />
                                    </Button>
                                    <Button
