...
export default function CreateQuizPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const res = await fetch(`/api/admin/internships/${internshipId}/quizzes`, {
                method: "POST",
            ...
            if (res.ok) {
                ...
                router.push(`/admin/internships/${internshipId}/quizzes`);
            } else {
    ...
    return (
        <div className="p-8">
            <div className="mb-8">
                <Link href={`/admin/internships/${internshipId}/quizzes`}>
            ...
            <form onSubmit={handleSubmit} className="space-y-6 max-w-4xl">
                ...
                <div className="flex gap-4">
                    ...
                    <Button
                        type="button"
                        variant="outline"
                        onClick={() => router.push(`/admin/internships/${internshipId}/quizzes`)}
                    >
                        Cancel
                    </Button>
                </div>
