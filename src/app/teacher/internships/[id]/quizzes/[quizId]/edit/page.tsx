...
export default function EditQuizPage() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                // Fetch existing quiz
                const quizRes = await fetch(`/api/teacher/internships/${internshipId}/quizzes/${quizId}`);
                if (quizRes.ok) {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const res = await fetch(`/api/teacher/internships/${internshipId}/quizzes/${quizId}`, {
                method: "PUT",
