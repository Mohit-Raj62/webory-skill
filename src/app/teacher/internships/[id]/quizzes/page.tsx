            ...
            <div className="mb-8">
                ...
                <div className="flex justify-between items-center">
                    <div>
                        ...
                        <p className="text-gray-400">Manage internship assessments</p>
                    </div>
                    <Link href={`/teacher/internships/${internshipId}/quizzes/new`}>
                            ...
                            <div className="flex justify-between items-start">
                                ...
                                <div className="flex gap-2">
                                    <Button
                                        variant="outline"
                                        size="sm"
                                        onClick={() => router.push(`/teacher/internships/${internshipId}/quizzes/${quiz._id}/results`)}
                                    >
                                    ...
                                    <Button
                                        variant="outline"
                                        size="sm"
                                        onClick={() => router.push(`/teacher/internships/${internshipId}/quizzes/${quiz._id}/edit`)}
                                    >
                                        <Edit size={16} />
                                    </Button>
                                    <Button
