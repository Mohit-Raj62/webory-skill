...
export default function AssignmentSubmissionsPage() {
    ...
    const fetchSubmissions = async () => {
        try {
            const res = await fetch(`/api/teacher/internships/${internshipId}/assignments/${assignmentId}/submissions`);
            if (res.ok) {
    ...
    const handleGrade = async (submissionId: string) => {
        try {
            const res = await fetch(
                `/api/teacher/internships/${internshipId}/assignments/${assignmentId}/submissions/${submissionId}`,
                {
                    method: "PUT",
