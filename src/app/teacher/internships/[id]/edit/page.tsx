...
import { ArrowLeft, Plus, X, Upload, Image, FileText, Trash2, Video, DollarSign, Users, Clock, Tag, Layers, CheckCircle, Loader2 } from "lucide-react";
...
export default function EditInternshipPage() {
    ...
    const fetchPDFs = async () => {
        try {
            const res = await fetch(`/api/teacher/internships/${params.id}/pdfs`);
            if (res.ok) {
        ...
        try {
            ...
            if (res.ok) {
                ...
                setFormData({
                    ...
                    level: data.internship.level || "Beginner",
                    price: data.internship.price || 0,
                    originalPrice: data.internship.originalPrice || 0,
                    discountPercentage: data.internship.discountPercentage || 0,
                    studentsCount: data.internship.studentsCount || "0",
                    language: data.internship.language || "English/Hindi",
                    promoVideoUrl: data.internship.promoVideoUrl || "",
                    promoVideoDuration: data.internship.promoVideoDuration || "",
                    lastUpdatedDate: data.internship.lastUpdatedDate || "",
                    color: data.internship.color || "from-blue-500 to-purple-500",
                    icon: data.internship.icon || "Globe",
                    duration: data.internship.duration || "0h",
                    thumbnail: data.internship.thumbnail || "",
                    certificateImage: data.internship.certificateImage || "",
                    curriculum: data.internship.curriculum || [],
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            const res = await fetch(`/api/teacher/internships/${params.id}`, {
                method: "PUT",
            ...
            if (res.ok) {
                ...
                await fetchInternship();
                 ...
                 const data = await res.json();
                toast.error(data.error || "Failed to update internship");
            }
        } catch (error) {
    ...
    const handlePDFUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        try {
            ...
            // 2. Save to database
            const apiUrl = `/api/teacher/internships/${params?.id}/pdfs`;
    ...
    const handleDeletePDF = async (pdfId: string) => {
        ...
        try {
            const res = await fetch(`/api/teacher/internships/${params.id}/pdfs/${pdfId}`, {
                method: "DELETE",
            });
        ...
        return (
            <div className="min-h-screen flex items-center justify-center bg-black/50">
                <div className="flex flex-col items-center gap-4">
                    ...
                    <p className="text-white text-lg font-medium">Loading internship data...</p>
                </div>
            </div>
        );
    }
        ...
        <div className="p-8 max-w-7xl mx-auto">
            ...
            <div className="mb-8 flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-4xl font-bold text-white mb-2 tracking-tight">Edit Internship</h1>
                    <p className="text-gray-400 text-lg">Update internship details and content management</p>
                </div>
                    ...
                    <div className="lg:col-span-2 space-y-8">
                        ...
                        <div className="glass-card border border-white/10 bg-black/40 backdrop-blur-xl p-8 rounded-3xl shadow-xl">
                            ...
                            <div className="space-y-6">
                                <div>
                                    <label className="text-sm text-gray-400 font-medium mb-2 block">Internship Title *</label>
                                    <input
                                        type="text"
                                        required
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div>
                                        <label className="text-sm text-gray-400 font-medium mb-2 block">Launch Date (Optional)</label>
                                        <input
                                            type="text"
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div className="md:col-span-2">
                                        <label className="text-sm text-gray-400 font-medium mb-2 block">Promo Video</label>
                                        <div className="relative rounded-2xl overflow-hidden border border-white/10 aspect-video flex items-center justify-center bg-black/40 mb-3 md:w-1/2">
                                            ...
                                            <label htmlFor="promo-video-upload-teacher-edit" className="absolute inset-0 cursor-pointer flex items-center justify-center bg-black/40 opacity-0 hover:opacity-100 transition-opacity">
                                                {uploadingPromoVideo ? <Loader2 className="animate-spin text-white" size={24} /> : <Upload size={24} className="text-white"/>}
                                            </label>
                                            <input type="file" id="promo-video-upload-teacher-edit" className="hidden" accept="video/*" onChange={handlePromoVideoUpload} disabled={uploadingPromoVideo} />
                                        </div>
                                        <div className="flex gap-2 items-center">
                                            <input
                                                type="text"
                                                placeholder="URL (optional)"
                                                className="flex-1 bg-white/5 border border-white/10 rounded-xl p-3 text-white placeholder-gray-500 focus:border-blue-500/50 outline-none transition-all focus:bg-white/10"
                                            ...
                                            <input
                                                ...
                                                className="w-32 bg-white/5 border border-white/10 rounded-xl p-3 text-white placeholder-gray-500 focus:border-blue-500/50 outline-none transition-all focus:bg-white/10"
                    ...
                    <div className="space-y-8">
                        ...
                        <div className="glass-card border border-white/10 bg-black/40 backdrop-blur-xl p-6 rounded-3xl shadow-xl">
                            ...
                            <div className="space-y-6">
                                ...
                                <div>
                                    <label className="text-sm text-gray-400 font-medium mb-2 block">Icon Name</label>
                                    <div className="flex items-center gap-2">
                        ...
                        <div className="glass-card border border-white/10 bg-black/40 backdrop-blur-xl p-6 rounded-3xl shadow-xl">
                            ...
                            <div className="space-y-6">
                                {/* Thumbnail */}
                                <div>
                                    <label className="text-sm text-gray-400 font-medium mb-2 block">Internship Thumbnail</label>
