                    ...
                    <div key={internship._id} className="glass-card p-6 rounded-2xl hover:border-white/20 transition-all">
                        <div className="flex items-start justify-between mb-4">
                            ...
                            <div className="flex gap-2">
                                <Link href={`/teacher/internships/${internship.slug || internship._id}/edit`}>
                        ...
                        <div className="mt-4 pt-4 border-t border-white/10">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                                <Link href={`/teacher/internships/${internship.slug || internship._id}/quizzes`}>
                                    <Button className="w-full bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700">
                                        <ClipboardList size={16} className="mr-1" />
                                        Quizzes
                                    </Button>
                                </Link>
                                <Link href={`/teacher/internships/${internship.slug || internship._id}/assignments`}>
                                    <Button className="w-full bg-gradient-to-r from-green-600 to-teal-600 hover:from-green-700 hover:to-teal-700">
                                        <FileText size={16} className="mr-1" />
                                        Assignments
                                    </Button>
                                </Link>
                                <Link href={`/teacher/internships/${internship.slug || internship._id}/edit`} className="sm:col-span-2">
