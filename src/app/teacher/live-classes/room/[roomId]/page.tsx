  ...
  return (
    <div className="flex flex-col h-[calc(100vh-100px)] w-full max-w-7xl mx-auto px-4 mt-6">
      <div className="mb-4 flex items-center justify-between">
        ...
        <div className="flex items-center space-x-4">
          ...
          <button 
            ...
            className="flex items-center px-4 py-2 text-sm bg-purple-600 hover:bg-purple-700 text-white rounded-lg transition-colors shadow-lg"
          >
            Copy Invite Link
          </button>
      ...
      <div className="flex-grow w-full">
        {/* We pass isTeacher=true because this is the teacher route */}
