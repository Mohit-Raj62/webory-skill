...
export default function TakeQuizPage() {
    ...
    const fetchQuiz = async () => {
        try {
            const res = await fetch(`/api/internships/${internshipId}/quizzes/${quizId}`);
            if (res.ok) {
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            console.log("Course ID:", internshipId);
            ...
            if (res.ok) {
                ...
                router.push(`/internships/${internshipId}/quiz/${quizId}/result?attemptId=${data.result.attemptId}`);
            } else {
