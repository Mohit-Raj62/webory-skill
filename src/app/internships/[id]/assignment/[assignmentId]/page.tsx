...
export default function SubmitAssignmentPage() {
    ...
    const fetchData = async () => {
        try {
            ...
            const resAssignment = await fetch(`/api/admin/internships/${internshipId}/assignments`);
            if (resAssignment.ok) {
            ...
            const resSubmission = await fetch(`/api/internships/${internshipId}/assignments/${assignmentId}/submit`);
            if (resSubmission.ok) {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            const res = await fetch(`/api/internships/${internshipId}/assignments/${assignmentId}/submit`, {
                method: "POST",
