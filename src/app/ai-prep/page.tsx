            ...
            <div className="relative pt-24 md:pt-32 pb-16 md:pb-20 px-4 sm:px-6 lg:px-8">
                ...
                <div className="max-w-7xl mx-auto relative z-10">
                    <div className="text-center mb-10 md:mb-16">
                        <div className="inline-flex items-center gap-2 bg-white/5 border border-white/10 rounded-full px-3 py-1 mb-4 md:mb-6 backdrop-blur-sm">
                    ...
                    <div className="grid md:grid-cols-2 gap-6 md:gap-10 max-w-5xl mx-auto">
                        ...
                        >
                            ...
                            <div className="h-full bg-[#0a0a0a]/80 rounded-2xl md:rounded-[2.3rem] p-6 md:p-10 flex flex-col relative z-10 hover:bg-[#0a0a0a]/60 transition-colors">
                                <div className="flex justify-between items-start mb-6 md:mb-10">
                                    <div className="p-4 md:p-5 bg-purple-500/10 rounded-xl border border-purple-500/20 text-purple-400 shadow-[0_0_20px_rgba(168,85,247,0.1)] group-hover:scale-110 group-hover:bg-purple-500/20 transition-all duration-500">
                                    ...
                                    <div className="flex flex-col items-end">
                                        ...
                                        <span className="text-[10px] md:text-xs font-mono text-purple-400 bg-purple-500/10 px-2.5 py-1 rounded-full border border-purple-500/20">INTERVIEW_V2</span>
                                    </div>
                                </div>

                                <h3 className="text-xl md:text-3xl font-bold text-white mb-3 md:mb-4 group-hover:text-purple-300 transition-colors">Mock Interview</h3>
                                ...
                                <div className="space-y-3 md:space-y-4 mb-8 md:mb-10">
                                    {[
                                        ...
                                        <div key={i} className="flex items-center text-[11px] md:text-sm text-gray-300 group-hover:text-white transition-colors">
                                            <div className="w-1.5 h-1.5 rounded-full bg-purple-500 mr-2.5 shadow-[0_0_8px_rgba(168,85,247,0.5)]" />
                                            {item}
                                        </div>
                                    ))}
                                </div>

                                <Button className="w-full h-12 md:h-14 bg-white/5 hover:bg-purple-600 text-white border border-white/10 hover:border-purple-500/50 rounded-lg md:rounded-xl group-hover:shadow-[0_0_30px_rgba(168,85,247,0.4)] transition-all duration-300 mt-auto text-sm md:text-lg font-bold tracking-wide uppercase">
                                    Initialize Session
                                </Button>
                            </div>
                        </div>
                        ...
                        <div 
                            className="group relative h-full bg-gray-900/40 backdrop-blur-xl border border-white/10 rounded-2xl md:rounded-[2.5rem] p-0.5 overflow-hidden hover:border-cyan-500/50 transition-all duration-500 hover:shadow-[0_0_50px_rgba(6,182,212,0.2)] cursor-pointer"
                        ...
                        >
                            ...
                            <div className="h-full bg-[#0a0a0a]/80 rounded-2xl md:rounded-[2.3rem] p-6 md:p-10 flex flex-col relative z-10 hover:bg-[#0a0a0a]/60 transition-colors">
                                <div className="flex justify-between items-start mb-6 md:mb-10">
                                    <div className="p-4 md:p-5 bg-cyan-500/10 rounded-xl border border-cyan-500/20 text-cyan-400 shadow-[0_0_20px_rgba(6,182,212,0.1)] group-hover:scale-110 group-hover:bg-cyan-500/20 transition-all duration-500">
                                        <BrainCircuit size={32} className="md:w-10 md:h-10" />
                                    </div>
                                    <div className="flex flex-col items-end">
                                        <span className="text-[8px] md:text-[10px] text-gray-500 uppercase tracking-wider font-bold mb-1">Protocol</span>
                                        <span className="text-[10px] md:text-xs font-mono text-cyan-400 bg-cyan-500/10 px-2.5 py-1 rounded-full border border-cyan-500/20">LOGIC_CORE_V1</span>
                                    </div>
                                </div>

                                <h3 className="text-xl md:text-3xl font-bold text-white mb-3 md:mb-4 group-hover:text-cyan-300 transition-colors">Aptitude Test</h3>
                                <p className="text-xs md:text-gray-400 mb-6 md:mb-8 leading-relaxed">
                                ...
                                <div className="space-y-3 md:space-y-4 mb-8 md:mb-10">
                                    {[
                                        ...
                                        <div key={i} className="flex items-center text-[11px] md:text-sm text-gray-300 group-hover:text-white transition-colors">
                                            <div className="w-1.5 h-1.5 rounded-full bg-cyan-500 mr-2.5 shadow-[0_0_8px_rgba(6,182,212,0.5)]" />
                                            {item}
                                        </div>
                                    ))}
                                </div>
