        ...
        <div className="glass-card bg-white/5 backdrop-blur-xl border border-white/10 p-8 rounded-3xl shadow-2xl relative overflow-hidden">
            ...
            <form onSubmit={handleSignup} className="space-y-5">
                ...
                <input
                    ...
                    className={`w-full bg-white/5 border border-white/10 rounded-xl px-10 py-3 text-white focus:border-blue-500 focus:outline-none transition-colors ${refCode ? 'opacity-70 cursor-not-allowed' : ''}`}
