export const INDIAN_STATES_CITIES: { [key: string]: string[] } = {
  ...
  "Assam": [
    ...
    "Karbi Anglong", "Karimganj", "Kokrajhar", "Lakhimpur", "Majuli", "Morigoan", 
  ...
  "Karnataka": [
    ...
    "Chamrajnagar", "Chikkaballapur", "Chikmagalur", "Chitradurga", "Dakshina Kannada", 
  ...
  "Madhya Pradesh": [
    ...
    "Ujjain", "Umaria", "Vidisha", "Niwari", "Mauganj", "Pandhurna", "Maihar"
  ],
  "Maharashtra": [
    ...
    "Nashik", "Osmanabad (Dharashiv)", "Palghar", "Parbhani", "Pune", "Raigad", 
    "Ratnagiri", "Sangli", "Satara", "Sindhudurg", "Solapur", "Thane", "Wardha", 
    "Washim", "Yavatmal", "Chhatrapati Sambhajinagar"
  ],
  "Manipur": [
